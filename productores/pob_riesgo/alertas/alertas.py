    ...
    try:
        ...
        with psycopg.connect(url) as connection:
            with connection.cursor() as cur:
                cur.execute('SELECT MAX(fecha) FROM "marts_CalidadAire_riesgo" LIMIT 1')
                res = cur.fetchone()
                ...
                if fecha_local is None or str(fecha_db) > fecha_local:
                    ...
                    cur.execute('SELECT * FROM "marts_CalidadAire_riesgo" WHERE fecha = %s', (fecha_db,))
