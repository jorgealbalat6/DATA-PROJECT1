...
TOPIC_DATOS = 'datos_pob_riesgo'
TOPIC_ALERTAS = 'alertas_pob_riesgo'

# Límites de calidad del aire desde marts_CalidadAire_riesgo (µg/m³)
LIMITES_CALIDAD = {
    'PM2.5': 10,
    'PM10': 20,
    'NO2': 40,
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            html.H1("⚠️ Dashboard Calidad del Aire - Población de Riesgo", 
...
if __name__ == '__main__':
    print("Iniciando Dashboard de Calidad del Aire - Población de Riesgo...")
    print(f"Consumiendo datos de tópicos: {TOPIC_DATOS}, {TOPIC_ALERTAS}")
    print(f"Límites configurados desde marts_CalidadAire_riesgo:")
